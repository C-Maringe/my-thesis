            ...
            <div className="flex flex-col gap-4 md:w-full">
              <div className="flex flex-col md:flex-row gap-5">
                <Input
                  ...
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setencripted_agent_account(e.target.value) }}
                ...
                <Input
                  id={"city"}
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setCity(e.target.value) }}
                  value={city}
                  label={"City"}
                  type={"number"} />
              </div>
              <div className="flex flex-col md:flex-row gap-5">
                <Input
                  id={"association"}
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setAssociation(e.target.value) }}
                  value={association}
                  label={"Association"}
                  type={"number"} />
                <Input
                  id={"agent_name"}
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setAgent_name(e.target.value) }}
                  value={agent_name}
                  label={"Agent name"}
                  type={"number"} />
              </div>
              <div className="flex flex-col md:flex-row gap-5">
                <Input
                  id={"encripted_billid"}
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setEncripted_billid(e.target.value) }}
                ...
                <Input
                  id={"payment_channels"}
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setPayment_channels(e.target.value) }}
              ...
              <div className="flex flex-col md:flex-row gap-5">
                <Input
                  ...
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setStandardised_amount(e.target.value) }}
                ...
                <Input
                  ...
                  onChange={
                    (e: { target: { value: SetStateAction<string>; }; }) => { setPrevious_transaction_count(e.target.value) }}
